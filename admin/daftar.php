...
<div class="login-wrapper">
	<div class="login-header">DAFTAR ADMIN</div>
	<div class="login-content">
        ...
        <input type="Button" name="lihat data" onClick="document.location='master/admin.php?tampil'" value="Lihat Data"  />
		</form>
	</div>
	<?php
		include "kon.php";
		if (isset($_POST['daftar'])) {
			...
			$kp 	= $_POST['kpassword'];
			$err 	= 0;
			$qu 	= mysqli_num_rows(mysqli_query($con,"SELECT username_admin FROM tb_admin WHERE username_admin='$u'"));
			$qe 	= mysqli_num_rows(mysqli_query($con, "SELECT email_admin FROM tb_admin WHERE email_admin='$e'"));
			$err_n 	= "";
			$err_e  = "";
			$err_u 	= "";
			$err_no = "";
			...
			if ($err >= 1) {
				...
				$q 		= mysqli_query($con, "INSERT INTO tb_admin (nama_admin, username_admin, email_admin, alamat_admin, hp_admin, pass)
